...
public class Result<T> {
     ...
     * @return Result<T> 包含指定数据的成功结果对象，状态码为 200，消息为"ok"
     */
     ...
     * @return Result<Void> 包含成功状态的 Result 对象，状态码为 200
     */
     ...
     * @return Result<T> 包含成功状态码(200)、消息和数据的 Result 对象
     */
     ...
     * @return 返回一个 Result<Void>对象，其中 code 为 500，message 为传入的错误消息
     */
     ...
     * @return 返回一个包含错误码和错误消息的 Result<Void> 对象
     */
     ...
     * @param data 操作返回的数据
     * @param operationTypeEnum 操作类型枚举
     * @return Result<T> 包含操作结果的 Result 对象
     */
