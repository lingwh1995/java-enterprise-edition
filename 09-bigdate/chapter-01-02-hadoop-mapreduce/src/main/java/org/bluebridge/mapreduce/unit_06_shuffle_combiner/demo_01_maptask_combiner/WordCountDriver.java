package org.bluebridge.mapreduce.unit_06_shuffle_combiner.demo_01_maptask_combiner;
 ...
 * 2. 注意事项：在本地 IDEA 中测试时，输出结果文件路径在 target/classes/hadoop/output/unit_06_shuffle_combiner/demo_01_maptask_combiner 目录中，需要手动查看运行结果
 *
 * @author lingwh
 * @date 2026/8/2 11:42
 */
...
public class WordCountDriver {
    ...
    public static void main(String[] args)
        ...
        if (args.length >= 2) {
            ...
            inputPath = new Path(basePath, "hadoop/input/unit_06_shuffle_combiner/demo_01_maptask_combiner");
            outputPath = new Path(basePath, "hadoop/output/unit_06_shuffle_combiner/demo_01_maptask_combiner");
        }
