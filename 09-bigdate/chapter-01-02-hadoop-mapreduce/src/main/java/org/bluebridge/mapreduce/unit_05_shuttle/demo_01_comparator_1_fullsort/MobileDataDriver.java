...
/**
 * shuttle时使用实体类实现接口 WritableComparable 方式对文件进行全排序的 MobileDataDriver 类
 *
 * 按总流量从大到小排序驱动类
 *
 * @author lingwh
...
public class MobileDataDriver {
    ...
    public static void main(String[] args)
        ...
        if (args.length >= 2) {
            ...
            inputPath = new Path(basePath, "hadoop/input/unit_05_shuttle/demo_01_comparator_1_fullsort");
            outputPath = new Path(basePath, "hadoop/output/unit_05_shuttle/demo_01_comparator_1_fullsort");
        }
