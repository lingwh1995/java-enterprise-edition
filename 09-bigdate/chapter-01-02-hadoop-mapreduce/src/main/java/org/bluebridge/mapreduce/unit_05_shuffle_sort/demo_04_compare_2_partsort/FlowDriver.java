...
import org.bluebridge.mapreduce.unit_05_shuffle_sort.demo_03_compare_2_fullsort.SortBySumDataDescAndUplinkDataDescComparator;

import java.io.IOException;
import java.net.URISyntaxException;

/**
 * shuttle 时使用新创建类继承 WritableComparator 方式对文件进行分区内排序的 FlowDriver 类
 *
 * 1. 功能描述：按总流量从大到小排序驱动类
 * 2. 注意事项：在本地 IDEA 中测试时，输出结果文件路径在 target/classes/hadoop/output/unit_05_shuffle_sort/demo_04_compare_2_partsort 目录中，需要手动查看运行结果
 *
 * @author lingwh
 * @date 2026/8/1 23:05
 */
public class FlowDriver {
    ...
    public static void main(String[] args)
        ...
        if (args.length >= 2) {
            ...
            inputPath = new Path(basePath, "hadoop/input/unit_05_shuffle_sort/demo_04_compare_2_partsort");
            outputPath = new Path(basePath, "hadoop/output/unit_05_shuttle_sort/demo_04_compare_2_partsort");
        }
